...
<html lang="ru">
	...
	<body>
		<div id="wrapper">
			...
			<div id="form">
				<form  method="POST">
					<p><input class="form-control" placeholder="Ваше имя" name="nameUser"></p>
					<p><textarea class="form-control" placeholder="Ваш отзыв" name="textUser"></textarea></p>
